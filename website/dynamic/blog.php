    ...
    <main>
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST' || (isset($_POST['back']) && $_POST['back'] == "back")) {
            ...
            foreach ($adminPostsArray as $year => $monthsInYear) {
                ...
                print ("<ul class=\"show\"><button class='yearButton'>$year</button>");
                ...
                foreach ($monthsInYear as $month => $daysInMonth) {
                    ...
                    print ("<li>
                        <form action=$prev method=\"POST\"><button type=\"submit\" name=$year value=$month>$monthAsWord</button></form></li>");
